...
<body id="login">
                    ...
                    <div class="row">
                        <div class="col-12 offset-xl-1 col-xl-10">
                            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="shadow mb-sm-5" id="form-gestor" novalidate>
                                <input type="hidden" name="seccion" value="<?php echo $mision_msg['seccion']; ?>">
                                <h3 class="mt-1 mb-4 text-center">Editar Misión</h3>
                                <div class="group pt-3 pt-md-4">
                                    <textarea name="mensaje" id="mensaje" rows="4" required="" autocomplete="off" onpaste="countChar();" onkeyup="countChar();" onkeypress="return limita(350);"><?php echo $mision_msg['descripcion']; ?></textarea><span class="barra"></span>
    ...
    <script>
        ...
        function validaMensaje(campo) {
            if(campo.value.trim().length > 350) {
                document.getElementById("error-msj").textContent = "El mensaje sólo puede tener máximo 350 caracteres.";
