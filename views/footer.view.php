    ...
    <div class="sec-footer py-3">
        <div class="row container mx-auto">
            <div class="col-12 col-md-0 col-lg-4 text-center">
                <img src="<?php echo PATH?>img/logo-mascota-primaria.png" class="img-footer" alt="Logotipo de la mascota del kinder">
            </div>
            <div class="col-12 col-md-6 col-lg-4 mt-3 mt-md-0">
                <div class="img-footer-2 text-center mb-2">
                    <img src="<?php echo PATH?>img/logo-mascota-primaria.png" class="size-img-footer" alt="Logotipo de la mascota del kinder">
                </div>
                ...
                <ul>
                    ...
                    <li><a href="https://villainfantilmi.edu.mx/" target="_blank">Nivel Preescolar </a></li>
                </ul>
            </div>
