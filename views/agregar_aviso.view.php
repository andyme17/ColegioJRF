                        ...
                        <div class="col-12 offset-xl-1 col-xl-10">
                            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" method="post" class="shadow mb-sm-5" id="form-gestor" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="thumb" class="form-control-file" id="thumb" accept=".jpeg,.jpg,.png" data-html="true" data-toggle="tooltip" data-placement="top" title="Formato: <b>jpg/jpeg/png</b> Dimensiones:  <b>1280 x 560 px</b> Tamaño:  <b>menor a 490 KB</b>" onchange="validaImagen(this);">
