            ...
            <div class="container">
              ...
              <div class="form-row mt-md-2">
                <div class="group col-12 col-sm-7">
                  ...
                  <label for="entidad-alu" class="float-label">Entidad federativa: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-md-2">
                <div class="group col-12 col-sm-7">
                  ...
                  <label for="entidad-tutor" class="float-label">Entidad federativa: <span class="text-danger">*</span></label>
