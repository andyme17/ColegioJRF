            ...
            <div class="container">
              ...
              <div class="form-row pt-1 pt-3">
                <div class="group col-sm-6">
                  ...
                  <label for="ap-pat-alu" class="float-label">Apellido paterno: <span class="text-danger">*</span></label>
                ...
                <div class="group col-sm-6">
                  ...
                  <label for="ap-mat-alu" class="float-label">Apellido materno: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-2">
                <div class="group col-sm-8">
                  ...
                  <label for="nombre-alu" class="float-label">Nombre(s): <span class="text-danger">*</span></label>
                ...
                <div class="group col-sm-4">
                  ...
                  <label for="edad-alu" class="float-label">Edad: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-2">
                <div class="group col-12 col-sm-8">
                  ...
                  <label for="curp" class="float-label">CURP: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-2 mt-md-3">
                <div class="col-12 col-sm-7 col-lg-5">
                  <div class="form-group ml-2">
                    <label for="lugar-nac">Lugar de nacimiento: <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-sm-5 col-lg-4 form-line">
                  ...
                  <label for="religion" class="float-label">Religion: <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-sm-4 col-lg-3 ml-sm-1 ml-lg-0">
                  ...
                  <label for="tipo-s" class="float-label">Tipo de sangre: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-2">
                <div class="group col-12 col-sm-7 col-md-6">
                  ...
                  <label for="calle-alu" class="float-label">Calle: <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-sm-5 col-md-3">
                  ...
                  <label for="num-int-alu" class="float-label">No. interior: <span class="text-danger">*</span></label>
                  <div id="error-int-1"></div>
                </div>
                <div class="group col-12 col-sm-5 col-md-3">
                  <input type="text" name="num-ext-alu" id="num-ext-alu" autocomplete="off" required><span class="barra"></span>
                  <label for="num-ext-alu" class="float-label">No. exterior: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-md-2">
                <div class="group col-12 col-sm-6">
                  ...
                  <label for="colonia-alu" class="float-label">Colonia: <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-sm-6">
                  ...
                  <label for="alcaldia-alu" class="float-label">Alcaldía o municipio: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-md-2">
                <div class="col-12 col-sm-7">
                  <div class="form-group ml-2">
                    <label for="entidad-alu">Entidad Federativa: <span class="text-danger">*</span></label>
                    <select class="form-control form-control-sm" name="entidad-alu" id="entidad-alu">
                      <option value="">Selecciona una opción</option>
                      <option value="Aguascalientes">Aguascalientes</option>
                      <option value="Baja California">Baja California</option>
                      <option value="Baja California Sur">Baja California Sur</option>
                ...
                <div class="group col-12 col-sm-5">
                  ...
                  <label for="cp-alu" class="float-label">Código Postal: <span class="text-danger">*</span></label>
                  <div id="error-cp-1"></div>
                </div>
              </div>
              <div class="form-row mt-md-3">
                <div class="col-12 col-md-6 col-lg-5 mt-2 mt-sm-0">
                  <label>¿Estuvo inscrito en otra escuela? <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-1 mt-md-3">
                <div class="group col-12 col-sm-6">
                  ...
                  <label for="ap-pat-tutor" class="float-label">Apellido paterno: <span class="text-danger">*</span></label>
                  <div id="error-ape-3"></div>
                </div>
                <div class="group col-12 col-sm-6">
                  <input type="text" name="ap-mat-tutor" id="ap-mat-tutor" autocomplete="off" required><span class="barra"></span>
                  <label for="ap-mat-tutor" class="float-label">Apellido materno: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-2">
                <div class="group col-12 col-sm-8">
                  ...
                  <label for="nombre-tutor" class="float-label">Nombre(s): <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-sm-4">
                  ...
                  <label for="edad-tutor" class="float-label">Edad: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-2 mt-md-3">
                <div class="col-12 col-sm-6">
                  <div class="form-group ml-1">
                    <label for="grado-estudio" class="">Último grado de estudios: <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-sm-6">
                  ...
                  <label for="ocupacion" class="float-label">Ocupación: <span class="text-danger">*</span></label>
              ...
              <div class="form-row">
                <div class="group col-12 col-sm-7 col-md-6">
                  ...
                  <label for="calle-tutor" class="float-label">Calle: <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-sm-5 col-md-3">
                  ...
                  <label for="num-int-tutor" class="float-label">No. interior: <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-sm-5 col-md-3">
                  ...
                  <label for="num-ext-tutor" class="float-label">No. exterior: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-md-2">
                <div class="group col-12 col-sm-6">
                  ...
                  <label for="colonia-tutor" class="float-label">Colonia: <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-sm-6">
                  ...
                  <label for="alcaldia-tutor" class="float-label">Alcaldía o municipio: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-md-2">
                <div class="col-12 col-sm-7">
                  <div class="form-group ml-2">
                    <label for="entidad-tutor">Entidad Federativa: <span class="text-danger">*</span></label>
                    <select class="form-control form-control-sm" name="entidad-tutor" id="entidad-tutor">
                      <option value="">Selecciona una opción</option>
                      <option value="Aguascalientes">Aguascalientes</option>
                      <option value="Baja California">Baja California</option>
                      <option value="Baja California Sur">Baja California Sur</option>
                ...
                <div class="group col-12 col-sm-5">
                  ...
                  <label for="cp-tutor" class="float-label">Código Postal: <span class="text-danger">*</span></label>
              ...
              <div class="form-row mt-md-2">
                <div class="group col-12 col-sm-6 col-md-4">
                  ...
                  <label for="tel-fijo" class="float-label">Teléfono Fijo: <span class="text-danger">*</span></label>
                  <div id="error-tel-1"></div>
                </div>
                <div class="group col-12 col-sm-6 col-md-4">
                  <input type="text" name="tel-cel" id="tel-cel" autocomplete="off" required><span class="barra"></span>
                  <label for="tel-cel" class="float-label">Teléfono Celular: <span class="text-danger">*</span></label>
                  <div id="error-tel-2"></div>
                </div>
                <div class="group col-12 col-sm-6 col-md-4">
                  <input type="text" name="tel-ofi" id="tel-ofi" autocomplete="off" required><span class="barra"></span>
                  <label for="tel-ofi" class="float-label">Teléfono de Oficina: <span class="text-danger">*</span></label>
                ...
                <div class="group col-12 col-md-8">
                  ...
                  <label for="email-tutor" class="float-label">Correo Electrónico: <span class="text-danger">*</span></label>
