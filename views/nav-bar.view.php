<header id="header">
    <nav class="menu">
        <div class="container-menu">
            <div class="logo">
                <div class="logo-name">
                    <a href="<?php echo PATH;?>"><img src="img/escudoJRF.png" alt="Logotipo de la escuela"></a>
                </div>
                <div class="icon-menu">
        ...
        <div class="menu-link">
            ...
            <a href="<?php echo PATH;?>servicios.php" class="opc">NUESTROS SERVICIOS</a>
            <a href="<?php echo PATH;?>" class="logo-center">
                <img src="img/escudoJRF.png" alt="Logotipo de la escuela">
            </a>
